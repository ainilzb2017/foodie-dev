...
import com.ainilzb.pojo.vo.MerchantOrdersVO;
...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderVO createOrder(SubmitOrderBo submitOrderBo) {
        ...
        newOrder.setLeftMsg(leftMsg);//订单的备注
        ...
        //2.根据itemSpecIds循坏保存订单商品信息表
        String[] itemSpectIdArr = itemSpecIds.split(",");
